...
<script>
    ...
    window.load_schedule = function(){
        ...
        $('#schedule-field tbody').html('<tr><td colspan="10" class="text-center">Please wait...</td></tr>')
                    ...
                    if (typeof(resp) != undefined) {
                        ...
                        if (Object.keys(resp).length > 0) {
                            ...
                            Object.keys(resp).map(k => {
                                ...
                                tr.append('<td class="">' + resp[k].from_location + '</td>')
                                tr.append('<td class="">' + resp[k].to_location + '</td>')
                            ...
                            $('#schedule-field tbody').html('<tr><td colspan="10" class="text-center"><b>THERE\'S NO DATA HERE!!</b>.</td></tr>')
                        }
                    }
                }
            },
    ...
    function manage(){
        $('.edit_schedule').click(function(){
            uni_modal('Edit Schedule', 'manage_schedule.php?id='+$(this).attr('data-id'))
        })
