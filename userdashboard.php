...
<body style="background-image: url('background.png'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
<?php session_start() ?>
<?php

  header('userdashboard.php?page=Homee');
