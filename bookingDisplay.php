            ...
            <tbody>
                ...
                ?>
                    <tr class="text-center">
                        ...
                        <td><?php echo $res['schedule_id']; ?></td>
                        <td><?php echo $res['ref_no']; ?></td>
                        <td><?php echo $res['name']; ?></td>
                        <td><?php echo $res['qty']; ?></td>
                        <td><?php echo ($res['status'] == 1) ? 'Paid' : 'Unpaid'; ?></td>
                        <td><?php echo $res['date_updated']; ?></td>
                        <td>
                            <a href="bookingDelete.php?id=<?php echo $res['id']; ?>" class="btn btn-danger">Delete</a>
                            <a href="bookingInsert.php?id=<?php echo $res['id']; ?>" class="btn btn-primary">Insert</a>
                        </td>
                    </tr>
                <?php
                }
